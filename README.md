...
- [news\_factory\_server](#news_factory_server)
  ...
  - [URL Endpoints, Filters, and Query Parameters](#url-endpoints-filters-and-query-parameters)
    - [URL Endpoints](#url-endpoints)
      - [`today.ics` Endpoint](#todayics-endpoint)
      - [`today_nnfx.ics` Endpoint](#today_nnfxics-endpoint)
  - [Filters and Query Parameters](#filters-and-query-parameters)
    - [Query Parameters](#query-parameters)
    - [`currencies` Parameter](#currencies-parameter)
    - [`impact-classes` Parameter](#impact-classes-parameter)
    - [`implementation` Parameter](#implementation-parameter)
    - [Combined Filters](#combined-filters)
  - [Example Configurations](#example-configurations)
    - [Configuration Snippet for `today.ics`](#configuration-snippet-for-todayics)
    - [Configuration Snippet for `today_nnfx.ics`](#configuration-snippet-for-today_nnfxics)
  - [Full Example Curl Commands](#full-example-curl-commands)
  - [Endpoint JSON Data](#endpoint-json-data)
